...
Base case: <br>
<p align="center"><img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/fdcf85d4bbadf95f8a881e897ad2f2f3.svg?invert_in_darkmode" align=middle width=192.14579999999998pt height=227.4921pt/></p>

Inductive Step: Assume the induction hypothesis <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/9e894cd31ed0bf8a806e6439e18bf9c3.svg?invert_in_darkmode" align=middle width=114.52089pt height=31.63940999999999pt/> holds true for all natural numbers <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/937d867d9b3d53c96323a9b2d9eb895f.svg?invert_in_darkmode" align=middle width=39.101865pt height=22.745910000000016pt/>, then <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/47254cc0748efff66781d00e7d91473e.svg?invert_in_darkmode" align=middle width=75.497895pt height=24.56552999999997pt/> is also true.
<p align="center"><img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/ccf336aba30172015bec93a68b83fe57.svg?invert_in_darkmode" align=middle width=353.39865pt height=351.84105pt/></p>

<p align="center"><img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/b7613b9d4641427cdd9f17c605d83c95.svg?invert_in_darkmode" align=middle width=186.23219999999998pt height=170.91855pt/></p>

Since <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/f4c41f8f1c3b7dd48f48efefb18aefa1.svg?invert_in_darkmode" align=middle width=60.790290000000006pt height=31.63940999999999pt/> for all <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/55a049b8f161ae7cfeb0197d75aff967.svg?invert_in_darkmode" align=middle width=9.830040000000002pt height=14.102549999999994pt/>, <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/cf7ca0f9bc62acfa986921e9aa8c2c4f.svg?invert_in_darkmode" align=middle width=48.052620000000005pt height=24.56552999999997pt/> is the closest integer to <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/cfa069674b2af4fbeee9a86152ac1fa5.svg?invert_in_darkmode" align=middle width=17.351729999999996pt height=31.63940999999999pt/>.

## Exercise 1.14
<center><img src="/home/joshua/sicp-exercises/chapter1/svgs/test-354.svg"/></center>

### Orders of Growth of Space
Looking at the tree, we can see the maximum height of the tree grows linearly with <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/55a049b8f161ae7cfeb0197d75aff967.svg?invert_in_darkmode" align=middle width=9.830040000000002pt height=14.102549999999994pt/>, hence it has a <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/272e3ab168729ac17efd78e4c03be40f.svg?invert_in_darkmode" align=middle width=35.30538pt height=24.56552999999997pt/> order of growth.

### Orders of Growth of Number of Steps
Looking at the tree, when at `(cc n 1)`, we only have 1 kind of coin, with the value 1. We can count the number of calls to the procedure `cc`, with <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/383821d4b13ac575f1bbeba070727876.svg?invert_in_darkmode" align=middle width=49.898475pt height=24.56552999999997pt/> as the cost in terms of time for `(cc n 1)`:
<p align="center"><img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/256419f68562d6b0b557e39cd0c21192.svg?invert_in_darkmode" align=middle width=118.18702499999999pt height=41.03451pt/></p>

Next, looking at `(cc n 2)`, we now have 2 kinds of coins, with the values 1 and 5. We apply a similar analysis:
<p align="center"><img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/b3c0c613e77f47d26b5c9f216556dda2.svg?invert_in_darkmode" align=middle width=219.40545pt height=90.369675pt/></p>

We can now see a pattern emerging, where with coin denominations <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/a2868dbfb2c20f84f02eccf9b085df07.svg?invert_in_darkmode" align=middle width=97.185165pt height=22.381919999999983pt/>:
<p align="center"><img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/d77c631f5aff6eb1356b81120d0870b5.svg?invert_in_darkmode" align=middle width=360.45405pt height=137.1315pt/></p>

Hence, for this problem, with 5 coin denominations, it has a <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/6e5cd5548e78f324882b23f4b485d4e0.svg?invert_in_darkmode" align=middle width=42.67989pt height=26.70657pt/> order of growth.
...
### Part b
`(sine a)` grows logarithmically in space and number of steps, <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/f2f7b56e81fa53092673a3dd94c32652.svg?invert_in_darkmode" align=middle width=55.681395pt height=24.56552999999997pt/>.

<p align="center"><img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/92d4aedb921c9c3c8856d632adadaf75.svg?invert_in_darkmode" align=middle width=168.59535pt height=128.687295pt/></p>
...
## Exercise 1.35
For <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/8539410543f02002b864328921768b23.svg?invert_in_darkmode" align=middle width=91.41363pt height=27.720329999999983pt/> and <img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/6cffa3b429b95cd03044fd558b5bd250.svg?invert_in_darkmode" align=middle width=67.596045pt height=33.20525999999999pt/>,
<p align="center"><img src="https://github.com/choo8/sicp-exercises/tree/master/chapter1/svgs/036286e589753bf95d2780591ff1fc7c.svg?invert_in_darkmode" align=middle width=181.86794999999998pt height=335.8971pt/></p>
